...
public class DES {
	...
	public final static int DECYPT = 1;
	/***************************** 压缩替换S-Box **************************************************/
	 ...
	 * @return
	 */
	public synchronized static String DES_3(String source, String key, int type) {
		if (source.length() != 16 || key.length() != 32)
			return null;
		String temp = null;
	...
	public synchronized static String mac_3des(String key, String data) {
		return MAC_3DES(key, null, data, ASC);
	}

	public synchronized static String MAC_3DES(String key, String vector,
	...
	public static void main(String[] args) throws Exception {
		...
		// String masterKeyA = "5555555555555555";
		// String dataA = "1415926535897932";
		// System.out.println(DES_1(dataA, masterKeyA, 0));
		// System.out.println("/*************Tripe-DES*************/");
		// 主密钥
		String masterKey = "1A8F01BA670E04B90E230B57197F61C2";
		// 数据
		String data = "141592653589793u";
		System.out.println(DES_3(data, masterKey, 0));
		// String dpk = getDPK("1111111111111111", "1111111111111111",
		// "11111111111111111111111111111111");
		// System.out.println(dpk);
		// // MAC算法
		// System.out.println("/*********************MAC_3DES****************/");
		// // String mac_data = "02007020048020C098111988"+
		// // "80350000000055804000000000000000000100011902100037"+
		// // "8880350000000055804D991220125300000000303130303030"+
		// // "3038303130343732323030313030303031313536F44616B8A0"+
		// // "5777AD2000000000000000000082";
		// String mac_data = "ABCDEFGHIJKLMNOPQRST";
		// String cipher = MAC_3DES(masterKey, null, mac_data, ASC);
		// System.out.println("mac 密文：" + cipher);
		// System.out.println("/****************ASC_MAC*****************/");
		// System.out.println(MAC_3DES("23C8131AE651046B1923DF7C8A5B0B6B", null,
		// "0220|020000|80000001|10000000180000001201308021000071", ASC));
	}
}
